...
<form action="/admin/AddToFix/${fixControl.fixId}/save" style="width:1000px; padding:10px;"  class="card" method="post" enctype="multipart/form-data">


  <input type="text" name="productId"  class="form-control mb-3" id="floatingInputDisabled" placeholder="product Id" value="${fixControl.fixId}" disabled>

<div class="form-floating mb-3">
  <input type="text" class="form-control" name="nameFix" id="floatingInput"  placeholder="Name" value="${fixControl.fixName}">
  <label for="floatingInput">name Fix</label>
</div>
<div class="form-floating mb-3">
  <input type="text" name="priceFix" class="form-control" id="floatingPassword" placeholder="Description" value="${fixControl.fixPrice}">
  <label for="floatingPassword">Price Fix</label>
</div>
<br>
