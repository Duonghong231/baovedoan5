...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
           <p class="fs-3 font-bold text-info">Repair Services Price List</p>
           <br>
           <div class="d-flex justify-content-around">
               <form action="/admin/searchFix" method="get" class="input-group flex-nowrap" role="search">
                     <input  name="keyFix"  class="form-control me-2"  type="search" placeholder="Search for product of list " aria-label="Search">
                   ...
                   <button class="btn btn-info text-white " style="margin-left:10px;" type="button" onclick="window.location.href='/admin/addFix'">Add Fix</button>
           </div>
           <br>
            <table class="table">
              <thead class="table table-success table-bordered border-primary">
                <tr>
                  <th scope="col">Fix Id</th>
                  <th scope="col">Fix Name</th>
                  <th scope="col">Fix Price</th>
              ...
              <c:forEach var="fix" items="${fixList}">
                <tr>
                  <th scope="row">${fix.fixId}</th>
                  <td>${fix.fixName}</td>
                   <td>${fix.fixPrice}</td>
                  <td>
                      <button class="btn btn-primary" type="button" onclick="window.location.href='/admin/EditFix/${fix.fixId}'">
                      ...
                      <button class="btn btn-danger" onclick="window.location.href='/admin/DeleteFix/${fix.fixId}'" type="button">X</button>
                  </td>
                </tr>
                </c:forEach>
