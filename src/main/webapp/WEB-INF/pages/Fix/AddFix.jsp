...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
<h2 style="text-align:center; margin-top:30px;" class="text-warning">Add Fix</h2>

<div class="container-1" style="display:inline-flex; width:100%; justify-content:center;">
<form action="/admin/AddFix" style="width:1000px; padding:10px;"  class="card" method="post" enctype="multipart/form-data">

<div class="form-floating mb-3">
  <input type="text" class="form-control" name="nameFix" id="floatingInput"  placeholder="Name">
  <label for="floatingInput">name Fix</label>
</div>
<div class="form-floating mb-3">
  <input type="text" name="priceFix" class="form-control" id="floatingPassword" placeholder="Description" >
