...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
            ...
            <form action="addCategories" style="width:1000px; padding:10px;"  class="card" method="post" enctype="multipart/form-data">


            <div class="form-floating mb-3">
              <input type="text" class="form-control" name="categoriesName" id="floatingInput"  placeholder="Name">
