        ...
        <div class="col py-3">
           ...
           <div class="d-flex justify-content-around">
               <form action="/admin/search" method="get" class="input-group flex-nowrap" role="search">
                   ...
                   <button class="btn btn-info text-white " style="margin-left:10px;" type="button" onclick="window.location.href='/admin/addProduct'">Add Product</button>
           </div>
           <br>
            <table class="table">
              ...
              <c:forEach var="product" items="${listStu}">
                <tr>
                  ...
                  <td><img width="100" height="100" src="/admin/getProductPhoto/<c:out value='${product.productId}'/>"></td>
                  <td>
