    ...
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
           ...
           <div class="d-flex justify-content-around">
               <form action="/admin/searchCategory" method="get" class="input-group flex-nowrap" role="search">
                     <input  name="keyword1"  class="form-control me-2"  type="search" placeholder="Search for Category of list " aria-label="Search">
                   ...
                   <button class="btn btn-info text-white " style="margin-left:10px;" type="button" onclick="window.location.href='/admin/addCategory'">Add Category</button>
           </div>
           <br>
            <table class="table">
              ...
              <c:forEach var="category3" items="${categories}">
                <tr>
                  <th scope="row">${category3.categoryId}</th>
                  <td>${category3.categoryName}</td>
                   <td>
                    <button class="btn btn-primary" type="button" onclick="window.location.href='/admin/EditCategory/${category3.categoryId}'">
                     ...
                     <button type="button" class="btn btn-danger" onclick="window.location.href='/admin/DeleteCategory/${category3.categoryId}'">X</button>
                   </td>
