        ...
        <div class="col py-3">
           ...
           <div class="d-flex justify-content-around">
               <form action="/admin/searchCategory" method="get" class="input-group flex-nowrap" role="search">
                   ...
                   <button class="btn btn-info text-white " style="margin-left:10px;" type="submit"  onclick="window.location.href='/admin/addCategory'">Add Category</button>
           </div>
           <br>
            <table class="table">
                ...
                <tr>
                  ...
                  <td>${category3.categoryName}</td>
                    <td>
                                         ...
                                         <button class="btn btn-danger" onclick="window.location.href='/admin/DeleteCategory/${category3.categoryId}'" type="button">X</button>
                                     </td>
