...
<main>
   <div class="container">
      ...
      <div class="d-flex justify-content-center">
       <p class="text-dark fs-3 font-medium" style="width:500px;">You have buy a successful in product.Please,You can check whether or not you have paid at <a href="/user/CheckOrderDetail">the time of delivery</a></p>
      </div>
   </div>
</main>
</body>
