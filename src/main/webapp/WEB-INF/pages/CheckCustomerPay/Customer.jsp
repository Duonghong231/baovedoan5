...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
            <h2 style="text-align:center; margin-top:30px;" class="text-warning">Check pay</h2>

            <div class="container-1" style="display:inline-flex; width:100%; justify-content:center;">
            <form action="/admin/customerToCheck/${customerCheck.customerId}/save" style="width:1000px; padding:10px;"  class="card" method="post" enctype="multipart/form-data">
  <input type="text" name="customerId"  class="form-control mb-3" id="floatingInputDisabled" placeholder="product Id" value="${customerCheck.customerId}" disabled>

            <div class="form-floating mb-3">
             <select name="customerCheck" class="form-select" aria-label="Default select example">
