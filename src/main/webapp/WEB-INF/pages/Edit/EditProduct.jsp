...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
<h2 style="text-align:center; margin-top:30px;" class="text-warning">Edit products</h2>

<div class="container-1" style="display:inline-flex; width:100%; justify-content:center;">
<form action="/admin/EditProduct/${productText.productId}/save" style="width:1000px; padding:10px;"  class="card" method="post" enctype="multipart/form-data">


  <input type="text" name="productId"  class="form-control mb-3" id="floatingInputDisabled" placeholder="product Id" value="${productText.productId}" disabled>

<div class="form-floating mb-3">
  <input type="text" class="form-control" name="name" id="floatingInput"  placeholder="Name" value="${productText.productName}">
  <label for="floatingInput">name products</label>
</div>
<div class="form-floating mb-3">
  <input type="text" name="description" class="form-control" id="floatingPassword" placeholder="Description" value="${productText.productDescription}">
  <label for="floatingPassword">description products</label>
</div>

<div class="form-floating mb-3">
  <input type="text" name="price" class="form-control" id="floatingPassword" placeholder="Price" value="${productText.productPrice}">
  <label for="floatingPassword">Price products</label>
</div>
<div class="form-floating mb-3">
  <input type="number" name="quantity" class="form-control" id="floatingPassword" placeholder="Quantity" value="${productText.quantity}">
